...
class Search {
	...
	public function __construct() {
		...
		$this->searchAPI_url = "https://services.boats.com/" . $auth->getApiKey() . "/mmp/search?OwnerPartyId=" . $party->getPartyID() . "&SalesStatus=Active" . "&MakeStringExact=" . $make->getMake() . "&condition=" . $cond->getCond();
