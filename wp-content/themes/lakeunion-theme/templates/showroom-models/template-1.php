...
<a href="#" class="go-top btn btn-primary btn-sm"><?php _e('Back to top'); ?></a>
    ...
    <?php if( !empty($featured_img) ) : ?>
        <div class="row">
            <div class="col-md-12 hidden-xs oem-featured-image">
...
<div class="container">
    ...
    <?php foreach($results as $class_name => $listings) : ?>
        ...
        <?php if($displaySelectBoxes) : ?>
            <div class="brand-filters col-lg-12">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 boat-item" id="boat-<?php echo $boat['DocumentID'] ?>">
                    <div class="oem-model-single">
                        <div class="oem-boat-title">
                            <h5><?php echo $boat['ModelYear'] ?> <?php echo $boat['MakeString'] ?> <span><?php echo $boat['Model'] ?></span></h5>
                        </div>
